...
public class MainActivity extends AppCompatActivity implements AddNoteActivity.AddNoteDialogListener , EditNoteActivity.EditNoteDialogListener{
    public static final String EXTRA_ID = "com.example.arturjakiel.shoplist.EXTRA_ID";
    public static final String EXTRA_TITLE = "com.example.arturjakiel.shoplist.EXTRA_TITLE";
    public static final String EXTRA_DESCRIPTION  = "com.example.arturjakiel.shoplist.EXTRA_DESCRIPTION";
    public static final String EXTRA_COMPLETE = "com.example.arturjakiel.shoplist.EXTRA_COMPLETE";
    public static final int ADD_NOTE_REQUEST = 1;

    // Name value
    public static final String ID_INDICATOR = "com.example.arturjakiel.shoplist.ID_INDICATOR";
    public static final String TITLE_INDICATOR = "com.example.arturjakiel.shoplist.TITLE_INDICATOR";
    public static final String DESCRIPTION_INDICATOR = "com.example.arturjakiel.shoplist.DESCRIPTION_INDICATOR";
    public static final String COMPLETE_INDICATOR = "com.example.arturjakiel.shoplist.COMPLETE_INDICATOR";
